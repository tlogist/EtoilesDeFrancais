...
async function main() {
  ...
  const vocabWords = [
    ...
    { french: "S'il vous plait", english: "Please (formal)", category: "greetings", pronunciation: "seel voo PLEH", week: 1 },
    ...
    { french: "Etre", english: "To be", category: "essentials", pronunciation: "EH-truh", week: 1 },
    ...
    { french: "Le cafe", english: "Coffee", category: "food-drink", pronunciation: "luh kah-FAY", week: 2 },
    ...
    { french: "La biere", english: "Beer", category: "food-drink", pronunciation: "lah bee-AIR", week: 2 },
    ...
    { french: "L'aeroport", english: "Airport", category: "travel", pronunciation: "lah-ay-roh-POHR", week: 2 },
    { french: "Le billet", english: "Ticket", category: "travel", pronunciation: "luh bee-YAY", week: 2 },
    { french: "A gauche", english: "To the left", category: "travel", pronunciation: "ah GOHSH", week: 2 },
    { french: "A droite", english: "To the right", category: "travel", pronunciation: "ah DRWAHT", week: 2 },
    ...
    { french: "Le metro", english: "Subway", category: "travel", pronunciation: "luh may-TROH", week: 2 },
    { french: "L'hotel", english: "Hotel", category: "travel", pronunciation: "loh-TEL", week: 2 },
    { french: "Ou est...?", english: "Where is...?", category: "travel", pronunciation: "oo EH", week: 2 },
    // Week 3: Emotions
    ...
    { french: "Fatigue(e)", english: "Tired", category: "emotions", pronunciation: "fah-tee-GAY", week: 3 },
    { french: "Enerve(e)", english: "Annoyed/Angry", category: "emotions", pronunciation: "ay-nair-VAY", week: 3 },
    { french: "Surpris(e)", english: "Surprised", category: "emotions", pronunciation: "sur-PREE(z)", week: 3 },
    { french: "Inquiet(e)", english: "Worried", category: "emotions", pronunciation: "ahn-kee-AY(t)", week: 3 },
    { french: "Fier/Fiere", english: "Proud", category: "emotions", pronunciation: "fee-AIR", week: 3 },
    { french: "Amoureux/se", english: "In love", category: "emotions", pronunciation: "ah-moo-RUH(z)", week: 3 },
    { french: "Decu(e)", english: "Disappointed", category: "emotions", pronunciation: "day-SU", week: 3 },
    ...
    { french: "Bientot", english: "Soon", category: "time", pronunciation: "bee-ahn-TOH", week: 3 },
    { french: "Deja", english: "Already", category: "time", pronunciation: "day-ZHAH", week: 3 },
    // Week 4: People
    ...
    { french: "Le collegue", english: "Colleague", category: "people", pronunciation: "luh koh-LEG", week: 4 },
    ...
    { french: "Ou", english: "Where", category: "questions", pronunciation: "OO", week: 5 },
  ...
  const phrases = [
    ...
    { french: "Enchante(e)", english: "Nice to meet you", context: "When introduced to someone", category: "essential-greetings", isSlang: false, week: 1 },
    { french: "A bientot", english: "See you soon", context: "Casual goodbye", category: "essential-greetings", isSlang: false, week: 1 },
    { french: "Bonne journee", english: "Have a nice day", context: "Leaving a shop or ending a conversation", category: "essential-greetings", isSlang: false, week: 1 },
    { french: "A tout a l'heure", english: "See you later (same day)", context: "When you'll see the person again today", category: "essential-greetings", isSlang: false, week: 1 },
    // Filler Words
    ...
    { french: "Quand meme", english: "Still/All the same", context: "Add emphasis or express persistence", category: "filler-words", isSlang: false, week: 2 },
    { french: "Bon ben", english: "Well then", context: "Transition or conclude", category: "filler-words", isSlang: false, week: 2 },
    { french: "Voila", english: "There you go/That's it", context: "Present something or conclude", category: "filler-words", isSlang: false, week: 2 },
    { french: "Euh...", english: "Um...", context: "Thinking pause", category: "filler-words", isSlang: false, week: 2 },
    // Reactions
    { french: "C'est genial !", english: "That's awesome!", context: "Express excitement", category: "reactions", isSlang: false, week: 2 },
    ...
    { french: "Ca m'enerve", english: "That annoys me", context: "Express frustration", category: "reactions", isSlang: false, week: 2 },
    ...
    { french: "C'est evident", english: "It's obvious", context: "State something is clear", category: "opinions", isSlang: false, week: 3 },
    // Agreement/Disagreement
    { french: "Tout a fait", english: "Absolutely/Exactly", context: "Strong agreement", category: "agreement-disagreement", isSlang: false, week: 3 },
    ...
    { french: "Ca depend", english: "It depends", context: "Non-committal response", category: "agreement-disagreement", isSlang: false, week: 3 },
    ...
    // Casual Speech
    { french: "T'inquiete", english: "Don't worry", context: "Reassure someone (casual)", category: "casual-speech", isSlang: true, week: 4 },
    ...
    { french: "Ca marche", english: "That works/Sounds good", context: "Agree to a plan", category: "casual-speech", isSlang: false, week: 4 },
    ...
    { french: "Stp", english: "Please (s'il te plait)", context: "Texting abbreviation", category: "texting", isSlang: true, week: 4 },
    ...
    { french: "Flaner", english: "To stroll/wander", context: "Walking around without purpose", category: "slang", isSlang: false, week: 5 },
    { french: "Un truc", english: "A thing/stuff", context: "Casual replacement for 'une chose'", category: "slang", isSlang: true, week: 5 },
    { french: "Galerer", english: "To struggle/have a hard time", context: "When something is difficult", category: "slang", isSlang: true, week: 5 },
    ...
    { french: "Ce n'est pas la mer a boire", english: "It's not that hard", context: "Idiomatic: 'it's not the sea to drink'", category: "advanced-expressions", isSlang: false, week: 5 },
  ];
